...
import { decodeAnswersResponse, decodeBumpQuestionResponse, decodeListDataResponse, decodeQuestionTextResponse, decodeViewQuestionResponse } from "../decoders";
...
export class AskModule extends Module {
    ...
    public viewQuestion(questionId: number): Call<ViewQuestionResponse> {
        return new Call<ViewQuestionResponse>(this.client, {
            fn: "ask.viewquestion",
            payload: {
     ...
     */
    public startConversation(answerId: number, content: string, unanonymize: boolean = false): Call<TCResponse> {
        return new Call<TCResponse>(this.client, {
    ...
    public getAnswers(questionId: number, mode: string, refId: number): Call<AnswersResponse> {
        return new Call<AnswersResponse>(this.client, {
            fn: "legacy.askapi",
            payload: {
    ...
    public bumpQuestion(questionId: number): Call<BumpQuestionResponse> {
        return new Call<BumpQuestionResponse>(this.client, {
            fn: "legacy.askapi",
            payload: {
                "arg1": String(questionId),
                "arg2": "0",
